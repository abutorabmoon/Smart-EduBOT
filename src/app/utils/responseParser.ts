...
export function parseResponse(response: string): ParsedResponse {
  ...
  if (!response || typeof response !== 'string') {
    console.error("parseResponse received invalid input:", response);
    return {
      content: "Error: No response received from the AI service.",
      topics: [],
      rawCode: undefined,
      codeTitle: undefined,
      postCodeContent: undefined,
      probableQuestionType: undefined
    };
  }

  console.log("=== FRONTEND PARSING START ===");
  console.log("Response to parse:", response.substring(0, 200) + "...");
  ...
  try {
    ...
    return {
      content: "Error parsing the AI response. Please try again.",
      topics: [],
      rawCode: undefined,
      codeTitle: undefined,
      postCodeContent: undefined,
